...
export declare type GetMissingTraitIdentifier = (traitType?: string) => string | undefined;
...
export declare type AttributeWithRarity = Attribute & RarityFields;
export declare type IsMissing = <T extends Token = Token>(trait_type: string, token: T) => boolean;
export declare type GetIsMissing = (getMissingTraitIdentifier: GetMissingTraitIdentifier) => IsMissing;
